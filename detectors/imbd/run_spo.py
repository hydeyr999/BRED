...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_file', type=str, default="./detectors/imbd/results/v1/")
    ...
    parser.add_argument('--op2',type=str,default='polish')
    parser.add_argument('--model2',type=str,default='llama')
    ...
    if args.task_name == 'llm-co' or args.task_name == 'op-co':
        val_data = CustomDataset_rewrite(args, data_json_dir=args.eval_dataset, mode='test',flag=args.flag)
    else:
    ...
    run(
        ...
        DEVICE=args.device,
        ckpt_dir=f"./detectors/imbd/ckpt/v1/{args.task_name}/{args.train_dataset}_n{args.n_sample}_ep{args.epochs}_spo_lr_{args.lr}_beta_{args.beta}_a_{args.a}",
        args=args
    )