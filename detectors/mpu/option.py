...
def get_parser():
    ...
    parser.add_argument('--local-model', type=str, default='../detectbt/models')
    ...
    parser.add_argument('--quick_val', type=int, default=0) # flag for quick validation: mix=full+sent.
