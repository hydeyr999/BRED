...
#python detectors/xlnet/run_xlnet.py --dataset HC3 --mode train --device $device \
...
#  --xlnet_model ./detectors/xlnet/weights/otherdata/xlnet_imbd_ep$epochs\_thres$threshold\_n$n_sample \
...
#  --xlnet_model ./detectors/xlnet/weights/otherdata/xlnet_imbd_ep$epochs\_thres$threshold\_n$n_sample\_False \
#  --device $device --epochs $epochs --threshold $threshold --n_sample $n_sample --multilen $multilen --imbddata True
#done
...
for operation in ${operations[@]}; do
  echo "Testing operation: $operation, epochs: $epochs, threshold: $threshold, n_sample: $n_sample"
  python detectors/xlnet/run_xlnet.py --task cross-operation --dataset $operation --mode test \
  --xlnet_model ./detectors/xlnet/weights/otherdata/xlnet_HC3_ep$epochs\_thres$threshold\_n$n_sample\_True \
