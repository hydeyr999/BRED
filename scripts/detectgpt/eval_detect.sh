...
#  echo "Evaluating operation translate on language $language"
#  python detectors/detectgpt/detectgpt.py --task cross-operation --dataset translate --device $device --multilen $multilen --language $language
#done